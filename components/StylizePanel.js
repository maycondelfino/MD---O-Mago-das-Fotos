...
export const StylizePanel = ({
  ...
  return (
    React.createElement("div", { className: `flex flex-col gap-4 ${isLoading ? 'opacity-60 pointer-events-none' : ''}` },
      React.createElement("div", null,
        React.createElement("label", { htmlFor: "style-select", className: "block text-sm font-medium text-slate-300 mb-2" }, "Estilo Art\xEDstico"),
        React.createElement("select", {
          ...
          styles.map(style => (
            React.createElement("option", { key: style.name, value: style.prompt }, style.name)
          ))
        )
      ),
      ...
      isLoading && (
        React.createElement("div", { className: "flex items-center justify-center text-sm text-slate-400 gap-2 mt-2" },
          React.createElement("svg", { className: "animate-spin h-4 w-4", xmlns: "http://www.w.org/2000/svg", fill: "none", viewBox: "0 0 24 24" },
            React.createElement("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }),
            React.createElement("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })
          ),
          React.createElement("span", null, "Estilizando...")
        )
      )
    )
  );
